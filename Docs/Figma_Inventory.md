...
- **Public:** Landing `317:3611`/`820:4179`, Blog `317:1969` (+detail `1597:9736`), FAQ `317:1878`, Our process `317:1352`, About `317:1525`, For Preceptors `317:1634`, Consulting `4044:15094`, legal `733:3328`/`736:3398`
  - **IN BUILD (public-site program, 2026-06-27 — `Plan_Public_Site.md`):** Landing shipped in LP-1; For Preceptors/Consulting (LP-2), About/Our Process/Our Team (LP-3), FAQ/Resources (LP-4), legal (LP-5). **Blog `317:1969` + detail `1597:9736` deferred** (content-source TBD).
